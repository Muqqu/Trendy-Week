        ...
        <div class="hero_area">
            <header class="header_section">
                ...
                <nav class="navbar navbar-expand-lg custom_nav-container ">
                    <img src="https://trendyweek.site/img/trendyweeklogo.png" alt="Logo" style="max-width: 100%; height: auto; display: block; margin: 0 auto;">
                            ...
                            <div class="carousel-item active">
                                <div class="container-fluid">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 ">
                                            <div class="img-box">
                                                <img src="{{ asset('img/slider-img.png') }}" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="box">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="img-box">
                                <img src="{{ asset('img/saving-img.png') }}" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="detail-box">
